...
public class ApiExceptionHandler {
    ...
    /**
     * Logs and formats parts of given stacktrace array that include classes of the {@link UserServiceApplicationTest} package (e.g. com.example...) but will 
    ...
    /**
     * Checks if given {@link StackTraceElement} references a class of the {@link UserServiceApplicationTest} package.
     * 
     * @param trace to check
     * @return true if referenced class is in {@link UserServiceApplicationTest} package
     */
    private static boolean isPackageStackTrace(StackTraceElement trace) {

        return trace.getClassName().startsWith(UserServiceApplication.class.getPackage().getName());
    }
